								...
								<tr valign="top">
									<td width="333px" height="235px" align="center">
										<div class="card border-primary mb-3"
											...
											<div class="card-header"><span id = "author1"></span></div>
											<div class="card-body">
												<a href="" id="link1"><h4 class="card-title" id="title1" style="font-weight: bold;"></h4></a>
												<p class="card-text" id="description1" style="font-size: small;"></p>
											</div>
										</div>
									</td>
									<td width="333px" height="235px" align="center">
										<div class="card text-white bg-primary mb-3"
											...
											<div class="card-body">
												<a href="" id="link2"><h4 class="card-title" id="title2" style="font-weight: bold; color: white;"></h4></a>
												<p class="card-text" id="description2" style="font-size: small;"></p>
											</div>
										</div>
									</td>
