	...
	$(document)
			.ready(
					function() { // 실시간 여행 기사 가져오는 코
						$
								.ajax({
									url : 'https://api.rss2json.com/v1/api.json?rss_url=http://www.traveltimes.co.kr/rss/S1N1.xml&api_key=vciu0xm0zzemy9hto9tncbiwdivayevqlxpehdgq&count=9',
									dataType : 'json',
									data : {
										url : 'http://www.traveltimes.co.kr/rss/S1N1.xml', // 원래 url
						...
						<td width="1000" height="800" rowspan="10" valign="top">
							<nav class="navbar navbar-expand-lg navbar-light bg-light">
								...
								<div class="collapse navbar-collapse" id="navbarColor01">
									...
									<form class="form-inline my-2 my-lg-0" name="f_search"
										...
										<table>
											<tr>
												<td><font size="4"><b><%=titleDate%>&nbsp;&nbsp;&nbsp;여행BIZ</b></font>
												</td>
											</tr>
										</table>
									</form>
							...
							<div align="right">
								<button type="button" class="btn btn-secondary"
									onclick='javascript:open_page("http://www.traveltimes.co.kr/news/articleList.html?sc_section_code=S1N1&view_type=sm")'>더보기</button>
							</div>
						</td>
					</tr>
