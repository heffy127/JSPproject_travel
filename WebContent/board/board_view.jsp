			...
			<div class="div_board" align="center">
				<table border="1">
					<tr>
							...
							<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
								...
								<div class="collapse navbar-collapse" id="navbarColor01">
									<ul class="navbar-nav mr-auto">
										<li class="nav-item active"><a class="nav-link" href="board.jsp">
												<font size="3">전체</font> <span class="sr-only">(current)</span>
											</a></li>
										<li class="nav-item"><a class="nav-link" href="boardLife.jsp">
												<font size="2">일상</font>
											</a></li>
										<li class="nav-item"><a class="nav-link" href="boardRecommend.jsp">
												<font size="2">추천</font>
											</a></li>
										<li class="nav-item"><a class="nav-link" href="boardQuestion.jsp">
												<font size="2">질문</font>
											</a></li>
									</ul>
									<form class="form-inline my-2 my-lg-0" name="f_search" method="get"
										action="board_search.jsp">
										<table>
											<tr>
												<td width="20">
												...
												<td>&nbsp;&nbsp;</td>
												<td><input class="form-control mr-sm-2" type="text" placeholder="전체 검색"
														name="keyword">
							...
							<div align="center">
								<form name="f" id="f" method="get">
									<table border="0" width="93%">
										...
										<tr>
											<td width="74%">
												<font size="6"><b><%=bdto.getSubject()%></b></font><br>
											</td>
											<td align="center">
												<font size="5" color="gray"><b><%=bdto.getWriter()%></b></font><br>
											</td>
										</tr>
										<tr>
											<td>
												...
												<font size="2" color="gray"><%=bdto.getNum()%>
													&nbsp;&nbsp;| &nbsp;&nbsp;<%=bdto.getReg_date()%></font>
											</td>
											<td align="center" >추천 &nbsp; 
											<font size="2" color="gray"><b id="goodPlace"><%=bdto.getGood()%></b></font>
												&nbsp;&nbsp;&nbsp; 조회 &nbsp; <font size="2" color="gray">
													<b><%=bdto.getReadcount()%></b></font>
											</td>
										</tr>
										<tr>
											<td colspan="2"><br>
												<div style="background-color: #f7f4f4; font-size: 14px; margin-top: 10px;"
													align="center">
													<table border="0">
														<tr>
						...
						<td rowspan="3" width="250" align="center">게시판 버튼 들어갈곳</td>
					</tr>
					<tr>
						<!-- 댓글 보여질 곳 -->
			...
			<div class="row">
				<div class="col-md-12 text-center">
					<p>
						...
						<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						</span> <span class="block">Demo Images: <a href="http://unsplash.co/"
