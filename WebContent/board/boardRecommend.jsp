					...
					<tr>
						<td width="1000" height="800" rowspan="10" valign="top">
							...
							<table class="table table-hover">
								...
								<tbody>
									<%
										...
										int listCnt = bdao.listCount_reco(); // DB에 있는 전체 게시글 수
										int startRow = (currentPage - 1) * pageSize;//  페이지마다 글 시작점
																					...
																					3 - 30~45 ...
																					*/
										ArrayList<BoardDTO> list = bdao.listBoard_reco(startRow, pageSize); // 내림차순 했기때문에 가장 최근글부터 출력
										//                                                              글 시작       나타날 글 개수
										if (list.size() == 0) {
									%>
							...
							<div align="center" style="width: '100px''">
								...
								<a href="boardRecommend.jsp?pageNum=<%=startPage - pageBlock%>"><font
									size="5">[이전]</font></a>
								<%
									}
								...
								%>
								<a href="boardRecommend.jsp?pageNum=<%=i%>"><font size="5">[<%=i%>]
								</font></a>
								<%
									}
										if (totPage > endPage) {
