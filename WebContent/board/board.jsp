						...
						<td width="1000"  height="800" rowspan="10" valign="top">
							...
							<table class="table table-hover">
								...
								<tbody>
									...
									<tr class="table-light">
										...
										%>
										<td align="center"><span class="badge badge-danger"><font size="2"><%=d.getPreface()%></font></span></td>
										<%
										} else {
										%>
							...
							if (listCnt > 0){ // 게시판 글이 하나라도 있는경우
								...
								*/
								...
								<a href="board.jsp?pageNum=<%=startPage - pageBlock %>"><font size="5">[이전]</font></a>
								<%}
									
								for(int i = startPage; i<=endPage; ++i){%>
							<a href="board.jsp?pageNum=<%=i %>"><font size="5">[<%=i %>]</font></a>
							<%} 
								if(totPage > endPage) { %> <!-- 전체 나타날 페이지가 한 페이지에 나타날 최대 버튼보다 클 경우, 즉 전체 페이지 수는 5인데 endpage가 3인경우 다음 버튼 나타나도록 -->
									<a href="board.jsp?pageNum=<%=startPage + pageBlock %>"><font size="5">[다음]</font></a>
								<% }
							}%>
							</div>
						</td>
