							...
							<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
								...
								<div class="collapse navbar-collapse" id="navbarColor01">
									<ul class="navbar-nav mr-auto">
										<li class="nav-item active"><a class="nav-link" href="#"><font size="3">전체</font>
												<span class="sr-only">(current)</span>
										</a></li>
										<li class="nav-item"><a class="nav-link" href="#"><font size="2">일상</font></a>
										</li>
										<li class="nav-item"><a class="nav-link" href="#"><font size="2">추천</font></a>
										</li>
										<li class="nav-item"><a class="nav-link" href="#"><font size="2">질문</font></a>
										</li>
									</ul>
