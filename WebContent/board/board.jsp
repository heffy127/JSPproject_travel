					...
					<div class="row">
						...
						<div class="col-xs-10 text-right menu-1">
							<ul>
								...
								<li class="has-dropdown active"><a href="board.jsp">소통광장</a>
									<ul class="dropdown">
				...
				<table border="0">
					<tr>
						<td width="1000" height="800" rowspan="10" valign="top">
								...
								<tbody>
									<%
										...
										int startRow = (currentPage - 1) * pageSize;//  페이지마다 글 시작점
																					...
																					3 - 30~45 ...
																					*/
										ArrayList<BoardDTO> list = bdao.listBoard(startRow, pageSize); // 내림차순 했기때문에 가장 최근글부터 출력
										//                                                              글 시작       나타날 글 개수
										if (list.size() == 0) {
									%>
									...
									<tr class="table-light">
										...
										%>
										<td align="center"><span class="badge badge-success"><font
												size="2"><%=d.getPreface()%></font></span></td>
										<%
											} else if (d.getPreface().equals("추천")) {
										%>
										<td align="center"><span class="badge badge-danger"><font
												size="2"><%=d.getPreface()%></font></span></td>
										<%
											} else {
										%>
										<td align="center"><span class="badge badge-dark"><font
												size="2"><%=d.getPreface()%></font></span></td>
										<%
											}
										%>
							...
							<div align="center" style="width: '100px''">
								...
								<a href="board.jsp?pageNum=<%=startPage - pageBlock%>"><font
									size="5">[이전]</font></a>
								<%
									}
								...
								%>
								<a href="board.jsp?pageNum=<%=i%>"><font size="5">[<%=i%>]
								</font></a>
								<%
									}
										if (totPage > endPage) {
					...
					<tr>
						...
						<td width="250" align="center" valign="top" height="285">
							<table border="1" bordercolor="#d8c5c7">
								...
								<tr bgcolor="#efefef">
									<td height="40"><a
										href="board_view.jsp?num=<%=bdto.getNum()%>"><h4>
					...
					<tr>
						<td align="center" height="170" valign="top"><a
							href='board.jsp'><img src="../images/free.jpg"></a></td>
					</tr>
					<tr>
						<td align="center" height="170" valign="top"><a
					...
					<tr>
						<td align="center" height="170" valign="top"><a
							href='../news/news.jsp'><img src="../images/news2.jpg"></a></td>
					</tr>
					<tr>
